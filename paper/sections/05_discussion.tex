...
experiment uses a 0.5B model on only 16 grade-school-math items by design;
its intervals are correspondingly wide, and it demonstrates the measurement
and logging mechanism cheaply rather than estimating a frontier effect size.
(v) The field moves weekly; figures are current as of August 10, 2026.
