...
\begin{enumerate}
    ...
    \item A live, reproducible 16-item pilot measuring self-consistency
    sampling against greedy decoding for a small open model, with complete
    traces and paired uncertainty, plus analyses of reasoning-effort calibration
